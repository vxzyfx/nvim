...
local ni_keymap = function(key, cmd)
  keymap('n', key, cmd, opts)
  keymap('i', key, cmd, opts)
end
-- Move to previous/next
ni_keymap('<A-,>', '<cmd>BufferPrevious<CR>')
ni_keymap('<A-.>', '<Cmd>BufferNext<CR>')
ni_keymap('<A-1>', '<Cmd>BufferGoto 1<CR>')
ni_keymap('<A-2>', '<Cmd>BufferGoto 2<CR>')
ni_keymap('<A-3>', '<Cmd>BufferGoto 3<CR>')
ni_keymap('<A-4>', '<Cmd>BufferGoto 4<CR>')
ni_keymap('<A-5>', '<Cmd>BufferGoto 5<CR>')
ni_keymap('<A-6>', '<Cmd>BufferGoto 6<CR>')
ni_keymap('<A-7>', '<Cmd>BufferGoto 7<CR>')
ni_keymap('<A-8>', '<Cmd>BufferGoto 8<CR>')
